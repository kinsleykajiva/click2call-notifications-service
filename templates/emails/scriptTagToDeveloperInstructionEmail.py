...
def scriptToDeveloperInstructions(activateLink:str):
	return r"""
...
<head>
  ...
  * {
  ...
  .header-background {
    background: repeat-x url #5F63D3 left bottom;
  }
...
<body bgcolor="#ffffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td background="#4246AF" bgcolor="#4246AF" width="100%" height="8" valign="top">
    ...
    <table bgcolor="#F5F5F5" class="body-wrap w320">
      <tr>
        <td></td>
        <td class="container">
          <div class="content">
            <table bgcolor="#F4F4F4" cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">  xxxxxxxxxxxxxxx &nbsp;</td>
                    </tr>
                  </table>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Howdy&nbsp; &nbsp;. </div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                            This is an email for the developers to get access to the Widget code copy  the code below and put it in the <strong>&lt;/body&gt;</strong> Tag of your site especially next the other javascript <strong>&lt;script&gt;</strong> tags.<br />
                            <br />
If questions please contact us&nbsp; .</td>
                          </tr>
                        </table>
                        <div style="text-align:left; ">
              <div
                        style="background-color:#4246AF;border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:10px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:38px;text-align:center;text-decoration:none;width:590px;-webkit-text-size-adjust:none;mso-hide:all;">           &lt;script  src="https://clicktocallbucket.s3.af-south-1.amazonaws.com/assets/js/widgetsrc-v-1.0.0.js?access="""+activateLink + """ " &gt;  &lt;/script&gt;
              </div>
