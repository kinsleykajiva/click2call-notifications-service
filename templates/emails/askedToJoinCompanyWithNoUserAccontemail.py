...
def askedToJoinCompanyWithNoUserAccountEmail(addedByUser:str,companyName :str, activateLink:str):
	return r"""
                      ...
                      <td class="body-padded">
                        ...
                        <table class="body-text">
                          <tr>
                            ...
                            You have been invited to be a user&nbsp;  """+ addedByUser + """ for <u> <strong> """+companyName + """ </strong> </u> Company .
                      </td>
                          </tr>
                        </table>
                        <div style="text-align:left; "><a href=" """+ activateLink + """ "
                        style="background-color:#4246AF;border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:38px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;">Setup Account</a></div>
